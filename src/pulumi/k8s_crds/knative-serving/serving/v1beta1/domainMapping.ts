...
export class DomainMapping extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: DomainMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "serving.knative.dev/v1beta1";
...
export interface DomainMappingArgs {
    readonly apiVersion?: pulumi.Input<"serving.knative.dev/v1beta1">;
    readonly kind?: pulumi.Input<"DomainMapping">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Spec is the desired state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.serving.v1beta1.DomainMappingSpecArgs>;
    /**
     * Status is the current state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly status?: pulumi.Input<inputs.serving.v1beta1.DomainMappingStatusArgs>;
}
