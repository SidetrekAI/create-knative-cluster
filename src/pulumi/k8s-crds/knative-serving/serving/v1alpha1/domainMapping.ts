...
export class DomainMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:serving.knative.dev/v1alpha1:DomainMapping';
    ...
    public readonly apiVersion!: pulumi.Output<"serving.knative.dev/v1alpha1" | undefined>;
     ...
     */
    public readonly spec!: pulumi.Output<outputs.serving.v1alpha1.DomainMappingSpec | undefined>;
    /**
     ...
     */
    public readonly status!: pulumi.Output<outputs.serving.v1alpha1.DomainMappingStatus | undefined>;
    ...
    constructor(name: string, args?: DomainMappingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "serving.knative.dev/v1alpha1";
            inputs["kind"] = "DomainMapping";
...
export interface DomainMappingArgs {
    readonly apiVersion?: pulumi.Input<"serving.knative.dev/v1alpha1">;
    readonly kind?: pulumi.Input<"DomainMapping">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Spec is the desired state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly spec?: pulumi.Input<inputs.serving.v1alpha1.DomainMappingSpecArgs>;
    /**
     * Status is the current state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    readonly status?: pulumi.Input<inputs.serving.v1alpha1.DomainMappingStatusArgs>;
}
